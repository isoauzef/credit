...
async function main() {
  ...
  if (fs.existsSync(submissionsPath)) {
    ...
    const checkoutData = raw
      ...
      .map((s) => ({
        ...
        amount: (Array.isArray(s.reviewLinks) ? s.reviewLinks.length : 1) * 40000,
  ...
  const settings = [
    ...
    { key: "stripe_price_per_review", value: "40000", group: "stripe" },
  ...
  const pageContent = [
    ...
    // Checkout page
    {
      ...
      content: {
        ...
        headingLine2: "Flat Fee of $400 Per Review",
    ...
    },
    {
      ...
      content: {
        ...
        steps: [
          ...
          { title: "Pay Only If It Works", desc: "Your card is charged $400 only after successful removal. If we can't remove it — you owe nothing." },
        ],
      },
    },
    {
      ...
      content: {
        ...
        faqs: [
          ...
          { q: "What if the review can't be removed? Do I still pay?", a: "No. You only pay the $400 fee after the review has been successfully and permanently removed. If we can't get it removed, you owe nothing." },
    ...
    },
    {
      ...
      content: {
        ...
        pricingInfo: "1-9 reviews: $400/review \u2022 10-19 reviews: $300/review \u2022 20+ reviews: $200/review",
